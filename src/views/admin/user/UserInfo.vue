<template>
  <div class="container">
    ...
    >
      ...
      <!--是否创建居民账户-->
      <el-form-item v-if="pageType === 'add'" label="加入居民账户" prop="is_create_res" label-position="top">
        <el-radio v-model="form.is_create_res" :label="1">是</el-radio>
        <el-radio v-model="form.is_create_res" :label="0">否</el-radio>
<!--        <el-input size="medium" clearable type="password" v-model="form.confirm_password" autocomplete="off"></el-input>-->
      </el-form-item>
