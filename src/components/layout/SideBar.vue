...
<!--      <img src="../../assets/img/koda.jpg" alt="" style="width: 50px; height: 50px;border-radius: 25px;" />-->
      <div style="color: white;font-size:20px;">交通时空大数据</div>
    </div>
    <div class="mobile-logo" v-else>
<!--      <img src="../../assets/img/mobile-logo.png" alt="" />-->
      <div style="color: white;font-size:20px;">交</div>
    </div>
